...
$total_sql = "SELECT COUNT(*) as total FROM contenido WHERE tipo_archivo_id BETWEEN 9 AND 12 AND nombre_prod LIKE ?";
...
$sql = "SELECT * FROM contenido 
        WHERE tipo_archivo_id BETWEEN 9 AND 12 
...
<div class="main">
    ...
    <div class="productos-grid">
        <!-- Añadir Producto -->
        <div class="producto-box" style="border: 2px dashed #00aaff; color: #00aaff; cursor: pointer; display: flex; flex-direction: column; justify-content: center; align-items: center; height: 200px;" onclick="location.href='añadir_contenido.php?tipo=imagen'">
